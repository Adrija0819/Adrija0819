...
**Test & Measurement:** Oscilloscopes, signal generators, multimeters, DC power supplies, NI Multisim, MPLAB X, LabVIEW

**Hardware & Systems:** Analog/digital circuits, PCB design, breadboard design, microcontrollers, signal conditioning, FPGAs
...
3. 🗄️**Self-Motorized Cabinet Lift: Electromechanical System Design - _Project Lead the Way_** 🚨
...
4. 🚀 **Autonomous Rover - _Lunar Autonomy Challenge (NASA)_** 🚀 
...
5. 🧬**Neural Network Implementation using Keras - _Break Through Tech (Cornell)_** 💻
